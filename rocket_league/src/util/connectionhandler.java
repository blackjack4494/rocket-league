...
public class connectionhandler {
	...
	// psyonixnetauthkey
	// final??
	private final static String PsyNetAuthKey = "9e533ee922f24a8799fe530003b7e37e";
	...
	// all private Strings
	private static String sid = "915e57dc86b2c96a03c5adec17e35fb8";
	...
	private final String Player = "&PlayerName=blackjack4494"; // steam display
																// name
	private final String PlayerID = "&PlayerID=76561198011004815"; // steamid
	private final String Platform = "&Platform=Steam"; // either Steam, (PS4 or
														// Xbox)?
	...
	// can be anything but contains some data like how often a user connected
	// the same day etc
	...
	// check auth status
	public static void chcheckstatus() throws Exception {
